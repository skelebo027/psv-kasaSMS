      ...
      {services.length === 0 ? (
        <Card>
          <CardHeader className="text-center py-12">
            <CardTitle className="text-2xl">No USSD Services</CardTitle>
            <CardDescription className="text-lg">
              You haven't created any USSD services yet. Get started by creating your first service.
            </CardDescription>
          </CardHeader>
          <CardContent className="text-center pb-12">
            <Button asChild size="lg">
              <Link href="/dashboard/ussd/create">
                ...
                Create Your First USSD Service
              </Link>
            </Button>
          </CardContent>
        </Card>
