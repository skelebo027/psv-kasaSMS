  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center">
        ...
        <div className="ml-auto font-medium">GH₵ 375</div>
      </div>
      <div className="flex items-center">
        <Avatar className="h-9 w-9">
          <AvatarImage src="/placeholder.svg" alt="Avatar" />
        ...
        <div className="ml-auto font-medium">GH₵ 600</div>
      </div>
      <div className="flex items-center">
        <Avatar className="h-9 w-9">
          <AvatarImage src="/placeholder.svg" alt="Avatar" />
        ...
        <div className="ml-auto font-medium">GH₵ 450</div>
      </div>
      <div className="flex items-center">
        <Avatar className="h-9 w-9">
          <AvatarImage src="/placeholder.svg" alt="Avatar" />
        ...
        <div className="ml-auto font-medium">GH₵ 288</div>
      </div>
      <div className="flex items-center">
        <Avatar className="h-9 w-9">
          <AvatarImage src="/placeholder.svg" alt="Avatar" />
        ...
        <div className="ml-auto font-medium">GH₵ 267</div>
      </div>
    </div>
  )
}
